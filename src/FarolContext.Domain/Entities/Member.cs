...
namespace FarolContext.Domain.Entities
{
    ...
    {
        public Member(Church church, EMemberType memberType, Name name, DateTime age, EGender gender, Document document, Email email, Contact contact, Address address) 
